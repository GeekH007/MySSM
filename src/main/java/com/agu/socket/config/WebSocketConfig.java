package com.agu.socket.config;


import com.agu.socket.config.interceptor.ChatHandshakeInterceptor;
import com.agu.socket.ChatSocket;
...
public class WebSocketConfig implements WebSocketConfigurer {
    ...
    @Autowired
    private ChatSocket chatHandler;
