package com.agu.socket;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.agu.domain.ChatResponse;
import com.agu.enums.ResponseTypeEnum;
...
public class ChatSocket implements WebSocketHandler {
    ...
    private static CopyOnWriteArraySet<WebSocketSession> webSocketSessions = new CopyOnWriteArraySet<WebSocketSession>();

    // 用户存放所有在线用户信息
    private static CopyOnWriteArraySet<Map<String, Object>> sessionAttributes = new CopyOnWriteArraySet<Map<String, Object>>();
